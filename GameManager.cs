...
namespace UNO.GameObjects{
    public class GameManager{
        ...
        public void PlayGame(){
            ...
            //Show what each player starts with
            ...
            while( !Players.Any( x => !x.Hand.Any())){
                if( DrawPile.Cards.Count < 4){ //small cheat here
            ...
            foreach( var player in Players){
                ...
                Console.WriteLine("Player " + Players.Position.ToString() + " has " + player.Hand.Sum( x => x.Score).ToString() + " points in their hand.");
            }
        }
